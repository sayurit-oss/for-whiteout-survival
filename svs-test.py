    ...
    return {
        "🚨 マッチング前": [
            ...
            },
            {
                "title": "スキル・連絡手段の決定",
                "blocks": [
                    {"type": "text", "content": "「いつまでに」「誰が」「何を」案内するかという全体スケジュールを確定させる。\n移動するプレイヤーへの案内が遅れないよう、逆算して「**当日18時頃までには移動先と戦術を各個別に連絡する**」というスケジュール目標をここで合意しておく。"},
        ...
        "⚔️マッチング後": [
            ...
            },
            {
                "title": "相手サーバーの火力の確認",
                "blocks": [
                    {"type": "text", "content": "* 執政官は自同盟のだれかに、サブ垢を作らせて、毎日、敵の主戦力となりそうな方々の火力を確認してもらう。"},
                    {"type": "text", "content": "* 特に上位の相手は、闘技場で、装備のスクショも含めて撮影、共有してもらう。"}
                ]
            },
            {
                "title": "戦力リストの作成と枠の確認",
