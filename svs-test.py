        ...
        "🏁 前日・当日に向けた最終調整・連絡": [
            {
                "title": "ホワイトリストの登録",
                "blocks": [
                    {"type": "text", "content": "決定した移籍メンバーのリストに基づき、各受け入れ先同盟（KFCやMMCなど）で対象者を盟主が「ホワイトリスト」に事前登録する。可能であれば移動が予想される人は登録しておく。"}
                ]
            },
            {
                "title": "R4の登録",
