        ...
        "⚔️マッチング後": [
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {"type": "file", "path": "past-data/260620 移籍者情報.xlsx", "label": "📊 過去の編成CSV(26/06/20)"},
                    {"type": "file", "path": "past-data/260715 移籍者情報.xlsx", "label": "📊 過去の編成CSV(26/07/18)"}
                ]
            }
        ],
        "🏁 最終調整・連絡": [
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {"type": "code", "content": "太陽城の配置図案\n                         北　\n                        ／ ＼ ①\n                   ／          ＼\n               ／                   ＼  ②\n西　   ／        太陽城       ＼　東　 \n       ⑤＼                           ／\n            ④＼                  ／  \n                     ＼         ／  \n                     ③ ＼／  　  　\n　　　　　　　南　　　　　　　　　① MMC3列②KFC3列 ③rlx2列 ④Ris2列⑤wan2列"},
                    {"type": "code", "content": "SVS担当同盟\n\n集結           MMC\nゴースト    KFC\nポイ活       rlx.Ris.wan\n\n砲台担当\n北   MMC  \n南   KFC    東  rlx.Ris  西  wan"},
                    {"type": "code", "content": "戦術共有は上Discordルームにて行います。\nチャットは【MMC・KFC同盟チャット】を使用します。\n\n20:20より、中小兄皇子（Ris）が説明を開始します。\n\n参加可能な方(聞き専可)は、事前に移籍・移転を済ませ、ボイスルームへお集まりください🙇"},
                    {"type": "code", "content": "【太陽城開始1分前】\n\n・集結主→行軍時間共有\n⇒\n・ゴースト→集結準備\n・王城組→単騎準備"},
                    {"type": "code", "content": "【解放後】\n王城組→単騎加速駐屯\nゴースト→集結開始\n✅成功\nゴースト解散\n↓敵集結確認\n↓再ゴースト\n❌失敗\nゴースト継続\n↓王城組帰還\n↓帰還後即集結                 📌行軍時間共有最優先"},
                    {"type": "code", "content": "【①相手がゴーストしない場合】\n\n敵集結\n↓王城防衛\n↓ゴースト集結開始\n↓敵が王城奪取\n↓ゴースト着弾、奪取\n↓王城組単騎で向かう\n↓受け渡し\n\n■ポイント・敵占領を長く続かせない・ゴースト→本命集結の流れ・敵着弾後5~10秒以内の奪還目標"},
                    {"type": "code", "content": "【②相手がゴーストする場合】\n\n敵集結①\n↓3917ゴースト①\n↓敵ゴースト①\n↓3917ゴースト②\nと言った感じになる\n・相手トップバフの集結後には確実にゴーストを入れる。\n・ゴーストをかぶせに来た時は、\nゴースト同盟がそこにさらに被せて集結を入れる\n・王城組が占領していない時は集結タイミングをずらして2個目の連撃を作ることでゴーストができる"},
                    {"type": "code", "content": "主砲＆ゴーストチームはボイチャで連携\n\ndiscordの｢3917鯖王国｣を使用\n\n\n             戦略Tボイチャ\n                     ／  ＼\n担当◯◯／          ＼担当◯◯\n             ／                  ＼\nMMCグルチャ      KFCグルチャ"},
                    {"type": "code", "content": "ジャスミン混合の説明\n\n相手とのバフ差が大きく、1発で駐在を抜かれる場合に使用します。\n理由は、ジャスミンの右上遠征スキルで、(40％の確率で全部隊の被ダメージを50％軽減)できるためです。\n発動率は40％と安定はしませんが、発動すれば相手の初撃を耐えられる可能性が大きく上がります。"},
                    {"type": "code", "content": "505の説明\nミアを必ず集結人は入れてください。\n3連するとしたら最初の2連はミアの505で削って、トップバフの人が3連目で防衛英雄で集結。すれば防衛英雄でも削れてるので抜ける可能性大。その後のカウンターにも備えることが可能。\n＋で一本集結かけておけば、防衛英雄集結で抜けなかった時の保険、また抜けた場合、駐屯がMAXになり磐石になる"},
                    {"type": "code", "content": "防衛時の左英雄4枚の内1枚にジャスミンを入れる"},
                    {"type": "code", "content": "■スケジュール\n～19:59： 移籍完了（移転不要）\n20:00～： 移転開始\n～21:00： ペットバフ/装飾バフ\n07:01～： 報酬受取後、自同盟へ帰還"}
                ]
            },
            {
