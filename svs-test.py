        ...
        "🚨 フェーズ1：事前準備・アナウンス": [
            {
                "title": "チーム発足",
                "blocks": [
                    {"type": "text", "content": "執政官が、自同盟のメンバーと相談の上、指揮官を任命。\n関連するメンバーでチャットグループを作成、戦略チーム（SVS戦略チーム等）として発足する。以降は必要に応じてメンバーを追加する。"}
                ]
            },
            {
                "title": "温存の呼びかけ",
                "blocks": [
                    ...
                    {"type": "text", "content": "情報漏洩防止のため、また世界チャットでは読まない人も現れるため、世界チャットではなく「盟主会」を通じて各同盟の盟主から同盟員へアナウンスを流してもらう。"},
                    {"type": "text", "content": "炉レベル30以上のプレイヤーへ、SVS準備フェーズ中の「副執政官」「教育部長」への積極的なエントリーを呼びかける。"}
                ]
            },
            {
                "title": "セキュリティ強化",
        ...
        "⚔️ フェーズ2：戦略と各同盟の役割決定": [
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {"type": "text", "content": "暇な人が現れないよう、王城と砲台集結のバランスを事前に想定しておくこと。〇〇な状態であれば砲台集結をしてもらう、基本的にはソロで砲台攻撃してもらい、号令で集結に乗ってもらうようにする、など。"},
                    {"type": "text", "content": "連撃部隊、ゴースト部隊を作ると決定した場合は、その部隊を埋めるだけの移籍者を集めてくる必要があります。"}
                ]
            },
            {
        ...
        "🔄 フェーズ3：移籍メンバーの選定と受け入れ調整": [
            {
                ...
                "blocks": [
                    ...
                    {"type": "text", "content": "候補者の「火晶レベル（上位28名など）」「ジェシー・パトリックの有無」「スキルや兵舎レベル」をまとめたデータを作成。"},
                    {"type": "text", "content": "上位5同盟へ移籍受け入れの承諾を取り、各同盟の「受入可能人数（空き枠数）」を確認（例: KFCは31人、MMCは30人など）。"}
                ]
            },
            {
                "title": "メンバーの割り振り決定",
                "blocks": [
                    ...
                    {"type": "text", "content": "KFC（主砲）へ火晶3のメンバーを優先して集めつつ、MMC（ゴースト）用にも火晶3メンバーを一定数（10〜15名程度）残すなど、戦力バランスを調整。なお、KFCに入りきらなかった残りの火晶2や火晶1のメンバーはMMCへ配置。"}
                ]
            },
            {
        ...
        "🏁 フェーズ4：当日に向けた最終調整・連絡": [
            {
                ...
                "blocks": [
                    ...
                    {"type": "text", "content": "【R4の登録】\n当日、王城で集結主が予想される人は盟主が「R4」にしておく。メンバーのリフレッシュ等の作業があるため。"},
                    {"type": "text", "content": "【インフラ確認と最終連絡】\n設定した「計3名のコマンダー体制」を軸に、Discordなどボイスチャットの通信環境と参加人数を最終確認。\n当日の18時頃までに、各プレイヤーに対して「どこの同盟へ移動するか」と「基本的な戦術（ポイ活徹するか、主砲に乗るか等）」を連絡する。"},
                    {"type": "text", "content": "準備フェーズでの相手のポイントの伸び方やバフの状況などを分析し、最終的な作戦（ゴースト発動の有無など）を決定・共有する。"},
                    {"type": "text", "content": "ポイ活移籍は〇〇同盟に移籍してください、とアナウンスする。"}
                ]
            },
            {
