        ...
        "⚔️マッチング後": [
            {
                ...
                "blocks": [
                    ...
                    {"type": "code", "content": "【SVS2カ国共通ルール】日本語版1/2\n●セカチャ、個チャにて宗教・政治の話╳\n●相手を挑発するコメント、スタンプ、郊外での行動╳\n●19:00〜02:29\n①同盟建築物への偵察・攻撃╳\n②タイルキル・テント╳\n③この時間の被害に対して即時報復は○\n●20:00以降の都市移転について\n準備フェーズの勝利国→東半分\n準備フェーズの敗戦国→西半分\n●02:30〜06:59\n①同盟建築物への偵察・攻撃╳\n②タイルキル・テント○\n③同一都市への攻撃は1回まで"},
                    {"type": "code", "content": "【SVS2カ国共通ルール】日本語版2/2\n●いかなる時間であっても、レッドゾーン、グレーゾーンでの攻撃は╳\n\n※ルール違反発覚時は、セカチャにて放送、相手の盟主へ連絡取る。\n※3917国民に対しての都市攻撃、タイルキル禁止\nーーーーーーーーーーーーーーーーー\n無料の8時間シールド使おう⚠⚠ \nアバター下のにゅいって矢印マーク\n4/25(土)\n●参加しない人は特に！！！！！\n16:00～19:00   1回目のシールド⚠\n23:00～24:00  ２回目のシールド⚠\n●戦線離脱後・寝落ちしそうになった時は、必ずシールド！！！"},
        ...
        "🏁 最終調整・連絡": [
            ...
            },
            {
                ...
                "blocks": [
                    ...
                    {"type": "code", "content": "太陽城の配置図( 張り出しイメージ)【4/25版】\n                         北　\n                 ⑤  ／ ＼ ①\n 　      ⑨  ／          ＼\n         ⑧  ／                   ＼  ③\n西　   ／        太陽城       ＼　東　 \n   　　＼                           ／\n          ④  ＼                  ／  ⑦\n                     ＼         ／  \n                   ②  ＼／  ⑥ 　  　\n　　　　　　　南"},
